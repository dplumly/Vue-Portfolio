<template>
    <footer id="contact">
		<ul>
			...
			<li class="fadeIn">
				<a id="thingiverse" href="https://cults3d.com/en/users/dplumly/3d-models" target="_blank">
					<svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27">
...
footer ul li a#blog::after,
footer ul li a#instagram::after,
footer ul li a#thingiverse::after,
footer ul li a#github::after,
footer ul li a#linkedin::after,
footer ul li a#resume::after,
